...
$result = $connection->query("SELECT * FROM user inner join laboratory on user.user_id=laboratory.user_id inner join hospital on laboratory.hospital_id=hospital.hospital_id WHERE user.user_id = '$student_id'");
...
$pdf->Ln();
$pdf->Cell(0, 10, 'Laboratory ID: ' . $docid);
$pdf->Ln();
