...
$url='http://localhost/cphrms/admin/patient_history.php?id=';
...
foreach ($history_array as $history) {
  ...
  $sql2 = "SELECT * from history where user_id='$recid' and date_started='$sd'";
  $r = mysqli_query($connection, $sql2);
  $record_exists = false;

  while($row = mysqli_fetch_assoc($r)) {
    $decrypted_history = decryptthis($row['history'], $key);
  ...
  if (!$record_exists && empty($errors)) {
    ...
    $sql = "INSERT INTO history(history,user_id,date_started,date_created) VALUES('$encrypted_history','$recid','$sd',NOW())";
 ...
 $sql3="SELECT * from history where user_id='$student_id'";
 ...
 if(mysqli_num_rows($r2)==0){
          ...
          $sql4 = "INSERT INTO history(history,user_id,date_started,date_created) VALUES('$history','$recid','$sd',NOW())";  
...
<h1>Patient Medical History</h1>
                     <form action="patient_history.php" method="POST" name="add_name" id="add_name">
					<?php
    	...
    	<label ></label>
                          ...
                          <thead style="  border-bottom: 1px solid #ddd;">
                            ...
                            <tbody>
                                <?php
                            $query="SELECT *  FROM history  WHERE user_id='$student_id'";
						  ...
						  <h6>Medical History:</h6>
                               ...
                               <table class="table table-bordered" id="dynamic_field">  
                                    <tr>  
                                         <td><input type="text" name="name[]" placeholder="Enter Medical History" class="form-control name_list" required/></td>  
